package com.vn.nguyenvansy.deepmovieapp.viewActivity;
        ...
        import com.vn.nguyenvansy.deepmovieapp.itemConfigAdapter.MessageAdapter;
        import com.vn.nguyenvansy.deepmovieapp.models.Message;
...
public class TrendingFilm extends AppCompatActivity {
    ...
    void bindingAction() {
        sendButton.setOnClickListener(this::onClickBtnSend);
    ...
    void callAPI(String question){
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization","Bearer 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")
                .post(body)
                .build();
